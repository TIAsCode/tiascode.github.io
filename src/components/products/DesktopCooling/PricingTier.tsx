...
const PricingTier: React.FC<PricingTierProps> = ({ tier }) => {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-gray-100 group h-full w-full flex flex-col">
      ...
      {/* CTA Button */}
      <button className="w-full bg-gray-50 text-gray-900 px-6 py-4 rounded-full hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:-translate-y-1 duration-300">
