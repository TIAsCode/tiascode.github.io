...
# Author: Eshan Roy
# Date: 2025.01.27
# Description: This script automates the process of committing changes to a GitLab repository
...
usage() {
    ...
    echo -e "  -b, --branch <branch_name>   Specify the branch to commit to (default: current branch)"
...
echo -e "${GREEN}Changes committed successfully with message: $COMMIT_MESSAGE${RESET}"
